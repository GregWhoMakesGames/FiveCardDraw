...
**Status:** Handoff for a fresh agent. Branch work for calling-draw pot odds / cascade / face-pair outs is in PR #3 (`cursor/dealer-open-validation-14c6`) — merge that before or with this stage.
