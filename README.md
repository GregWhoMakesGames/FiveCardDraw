...
post-draw face-pair betting, opener draw-count / check-mix protection,
non-bluff EV by class × draw count, post-draw cap, and Ring 1 bluff 3-bet
indifference — see
...
[docs/NEXT_STAGE_NONBLUFF_EV.md](docs/NEXT_STAGE_NONBLUFF_EV.md),
[docs/NEXT_STAGE_POSTDRAW_CAP.md](docs/NEXT_STAGE_POSTDRAW_CAP.md),
[docs/NEXT_STAGE_POSTDRAW_BLUFF.md](docs/NEXT_STAGE_POSTDRAW_BLUFF.md), and
